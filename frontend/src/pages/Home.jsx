...
function Home() {
    ...
    const genres = [...new Set(videos.map((item) => item.category))];
        ...
        <>
            ...
            {videos.length ? (
                genres.map((genre, index) => {
                    const videosByGenre = videos.filter(
                        (video) => video.category === genre
                    );
                ...
                <div className='container p-3 mx-auto flex items-center justify-center pb-20'>
                    <div className='text-center'>
                        <p className='text-gray-500 text-6xl font-bold'>
                            Sorry
                        </p>
                        ...
                        <p className='text-gray-500'>
                            There are no any content in Platform.Upload your
                            contents.
                        </p>
                    </div>
                </div>
