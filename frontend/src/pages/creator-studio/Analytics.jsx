            ...
            <div className='container mx-auto'>
                <div className='grid grid-cols-5 gap-2 pt-20'>
                    ...
                    <div className='col-span-4 gap-2 space-y-2'>
                        ...
                        <div className='bg-gray-300 bg-opacity-5 p-3'>
                            {isGetChannelLoading ||
                            isChannelAnalyticsLoading ? (
                                <Spinner />
                            ) : (
                                <div className='grid md:grid-cols-3 gap-2 max-h-[70vh] overflow-scroll overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-700'>
                                    <div
                                        className='bg-gray-600 bg-opacity-30 p-2'>
